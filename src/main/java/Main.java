    ...
    public static void main(String[] args) {
        ...
        try (S3Client s3Client = S3ClientFactory.createClient(accessKey, secretKey, sessionToken, region)) {
            ...
            for (Path csvFile : csvFiles) {
                ...
                if (rows.isEmpty()) {
                    System.out.println("Arquivo vazio: " + csvFile.getFileName());
                    continue;
                }
...
//                        );
                ...
                System.out.println("Limites carregados para " + macAddress);
                System.out.println("CPU: normal=" + cpuNormal + " critico=" + cpuCritic);
                System.out.println("RAM: normal=" + ramNormal + " critico=" + ramCritic);
                System.out.println("Disco: normal=" + discoNormal + " critico=" + discoCritic);
                System.out.println("NetSend: normal=" + networkSendNormal + " critico=" + networkSendCritic);
                System.out.println("NetRecv: normal=" + networkReceivedNormal + " critico=" + networkReceivedCritic);
                ...
                System.out.println("Chamando uploadAllCSV para o trusted: " + outputFolder);
